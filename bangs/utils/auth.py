...
def token_request(code):
    url = 'https://id.twitch.tv/oauth2/token?client_id={}&client_secret={}&code={}&grant_type=authorization_code&redirect\
        _uri={}'.format(CLIENT_ID, CLIENT_SECRET_ID, code, REDIRECT_URI)
...
def refresh_token(token):
    url = 'https://id.twitch.tv/oauth2/token?client_id={}&client_secret={}&grant_type=refresh_token&refresh_token={}'\
        .format(CLIENT_ID, CLIENT_SECRET_ID, token)
